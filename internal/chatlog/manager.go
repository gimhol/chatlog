...
func (m *Manager) Run(configPath string, opts RunOpts) error {
	var err error
	m.ctx, err = ctx.New(configPath)
	if err != nil {
		return err
	}
	m.ctx.RPCNetwork = opts.RPCNetwork
	m.ctx.RPCAddress = opts.RPCAddress
...
func (m *Manager) GetDataUsage() string {
	return m.ctx.DataUsage
}
func (m *Manager) GetWorkUsage() string {
	return m.ctx.WorkUsage
}
func (m *Manager) GetStatus() string {
	return m.ctx.Status
}
func (m *Manager) GetAccount() string {
	return m.ctx.Account
}
func (m *Manager) GetPID() int {
	return m.ctx.PID
}
func (m *Manager) GetExePath() string {
	return m.ctx.ExePath
}
